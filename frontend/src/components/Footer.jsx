    ...
    <footer id="contact">
      <div className="footer-blocks fade-in">
          ...
          {!submitted ? (
            <form className="cf-form" onSubmit={handleSubmit}>
              <div className="cf-row">
                <div className={`cf-field ${activeField === 'nome' ? 'is-active' : ''} ${form.nome ? 'is-filled' : ''}`}>
                  ...
                  <div className="cf-input-wrap">
                    <label className="cf-label">{t('footer.labelNome')}</label>
                    <input
                      type="text"
                      name="nome"
                      className="cf-input"
                      placeholder={t('footer.placeholderNome')}
                      required
                      autoComplete="off"
                      value={form.nome}
                ...
                <div className={`cf-field ${activeField === 'whatsapp' ? 'is-active' : ''} ${form.whatsapp ? 'is-filled' : ''}`}>
                  ...
                  <div className="cf-input-wrap">
                    <label className="cf-label">{t('footer.labelWhatsapp')}</label>
                    <input
                      type="tel"
                      name="whatsapp"
                      className="cf-input"
              ...
              <div className={`cf-field ${activeField === 'email' ? 'is-active' : ''} ${form.email ? 'is-filled' : ''}`}>
                ...
                <div className="cf-input-wrap">
                  <label className="cf-label">{t('footer.labelEmail')}</label>
                  <input
                    type="email"
                    name="email"
                    className="cf-input"
              ...
              <div className={`cf-field ${activeField === 'mensagem' ? 'is-active' : ''} ${form.mensagem ? 'is-filled' : ''}`}>
                ...
                <div className="cf-input-wrap">
                  <label className="cf-label">{t('footer.labelProjeto')}</label>
                  <textarea
                    name="mensagem"
                    className="cf-input cf-textarea"
                    placeholder={t('footer.placeholderProjeto')}
                    rows="3"
                    value={form.mensagem}
                    onChange={handleChange}
              ...
              <div className="cf-submit-wrap">
                ...
                >
                  {loading ? t('footer.enviando') : t('footer.enviarBriefing')}
            ...
            <div className="cf-success" style={{ display: 'flex' }}>
              ...
              <h4>{t('footer.sucessoTitulo')}</h4>
              <p>{t('footer.sucessoTexto')}</p>
            </div>
          )}
        </div>
        ...
        <div className="footer-block footer-block-hire">
          ...
          >
            {t('footer.trabalheConosco')} <span>&rarr;</span>
          </a>
        </div>
      </div>
